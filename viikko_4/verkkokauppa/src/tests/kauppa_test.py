...
class TestKauppa(unittest.TestCase):
    ...
    def test_kaupan_ostos_kahdella_eri_tuotteella(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kaupan_ostos_kahdella_samalla_tuotteella(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kaupan_ostos_kahdella_tuotteella_toista_on_varastossa_toista_ei_tarpeeksi(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_ostos_pois_korista(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
